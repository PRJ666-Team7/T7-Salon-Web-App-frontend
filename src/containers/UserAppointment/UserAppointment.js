    ...
    if (Cookies.get("user")) {
      ...
      if (user !== undefined) {
        async function getData() {
          ...
          setAppointment(data.data.map(i => {
          ...
          <React.Fragment>
            <Grid item xs={12}>
              <Paper>
                <Grid container>
                  <Grid item xs={11}>
                    <Typography><b>Employee Name: </b>{a.name}</Typography>

                    <Typography><b>Services: </b>{a.service.join(", ")}</Typography>

                    <Typography><b>Estimated Price: </b>${a.price}</Typography>

                    <Typography><b>Appointment Time: </b>{a.date} from {a.startTime} to {a.endTime}</Typography>
                  </Grid>
